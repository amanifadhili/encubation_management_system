...
const sidebarLinksByRole: Record<string, NavItem[]> = {
  director: [
    ...
    { name: "Users", to: "/users" },
    {
      ...
      children: [
        ...
        { name: "Material Requests", to: "/requests" },
        { name: "Teams", to: "/teams" },
        { name: "Inventory Analytics", to: "/reports/inventory" },
        { name: "Request Analytics", to: "/reports/requests" },
        { name: "Consumption Reports", to: "/reports/consumption" },
      ],
    },
    { name: "Projects", to: "/projects" },
    { name: "Mentors", to: "/mentors" },
  ...
  incubator: [
    ...
    { name: "Mentor", to: "/mentors" },
    {
      name: "Material Requests",
      children: [
        { name: "My Requests", to: "/requests" },
        { name: "Create Request", to: "/requests/new" },
        { name: "Templates", to: "/requests/templates" },
      ],
    },
    { name: "Messaging", to: "/messaging" },
    { name: "Announcements", to: "/announcements" },
